...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        className="xl:w-[75%] lg:w-[75%] md:w-[90%] sm:w-[75%] w-[90%] lg:h-[90%] h-[90%] xl:overflow-hidden overflow-x-hidden bg-gray-300 bg-opacity-75 rounded-lg text-white relative"
      ...
      >
        {cryptoDetails ? (
          <div className="flex md:flex-row flex-col items-center justify-between lg:h-full h-auto w-full p-4 relative">
            ...
            <div className="flex flex-col md:w-[55%] h-[70vh] md:pl-4 pl-0 md:mt-0 mt-2">
              <Chart />
